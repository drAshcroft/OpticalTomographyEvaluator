...
{
    public class Bil_IRT : ReconTemplate
    {
        #region Properties
                        ...
                        {
                            {
                                ...
                                w[0] = 1;
                                w[1] = noiseVar / (noiseVar + Math.Abs(DensityGrid[sliceNumber, x + 1, y] - observed));
                                w[2] = noiseVar / (noiseVar + Math.Abs(DensityGrid[sliceNumber, x - 1, y] - observed));
                                w[3] = noiseVar / (noiseVar + Math.Abs(DensityGrid[sliceNumber, x, y + 1] - observed));
                                w[4] = noiseVar / (noiseVar + Math.Abs(DensityGrid[sliceNumber, x, y - 1] - observed));
                                w[5] = noiseVar / (noiseVar + Math.Abs(DensityGrid[sliceNumber + 1, x, y] - observed));
                                w[6] = noiseVar / (noiseVar + Math.Abs(DensityGrid[sliceNumber - 1, x, y] - observed));


                                theta1 =
                                    observed 
                                    + DensityGrid[sliceNumber, x + 1, y]*w[1]
                                    + DensityGrid[sliceNumber, x - 1, y] * w[2]
                                    + DensityGrid[sliceNumber, x, y + 1] * w[3]
                                    + DensityGrid[sliceNumber, x, y - 1] * w[4]
                                    + DensityGrid[sliceNumber + 1, x, y] * w[5]
                                    + DensityGrid[sliceNumber - 1, x, y] * w[6]
                                    ;
                                ...
                                predicted = observed * lambda + theta1 * weight/ (w[0]+w[1]+w[2]+w[3]+w[4]+w[5]+w[6]);
                                if (predicted > 0)
                                    DensityGrid[sliceNumber, x, y] = predicted;
                                else
