...
{
    public class TIKRecon4 : ReconTemplate
    {
        #region Properties
        ...
        public float[, ,] DoProjections()
        {
            ...
            for (int j = 0; j < nIterations; j++)
            {
                ...
                calmFactor = (float)(1.3f / Math.Sqrt(j + 1));// 3f / DensityGrid.GetLength(0);
