...
namespace ReconstructCells
{
    ...
    public class OnDemandImageLibrary
    {
        ...
        public OnDemandImageLibrary(int numImages, bool PersistInMemory)
        {
            mVisionGateImage = false ;
            mOriginalFilenames = new string[numImages];
            mImageLibrary = new Image<Gray, float>[numImages];
        ...
        public OnDemandImageLibrary(OnDemandImageLibrary origLib)
        {
            origLib.LoadLibrary();

            int numImages = origLib.Count;
            bool PersistInMemory = origLib.mPersistInMemory;
            string TempFolder = origLib.mTempFolder;
            bool VisionGateImages = false;
            ...
            {
                origLib.mImageLibrary[i].ROI = Rectangle.Empty;
                this.mImageLibrary[i] = origLib.mImageLibrary[i].Copy();
            }
        }
        ...
        /// <summary>
        /// Compression shows quality (0 = highest compression, 100 = none)
        /// </summary>
        /// <param name="Filepattern"></param>
        /// <param name="Compression"></param>
        public void SaveImagesCompressed(string Filepattern, int Compression)
        {
            string extension = Path.GetExtension(Filepattern).ToLower();
            string directory = Path.GetDirectoryName(Filepattern);
            if (Directory.Exists(directory) == false)
            ...
            if (extension == "" || extension == ".tif" || extension == ".tiff")
            {
                ...
                for (int i = 0; i < mImageLibrary.Length; i++)
                {
                    ...
                    {
                        string filename = string.Format("{0}{1:000}.tif", fileAndDir, i);
                        ImageProcessing.ImageFileLoader.Save_Compressed(filename, mImageLibrary[i], Compression);
                    }
                }
            }
            else
        ...
        public void Save16bitImages(string Filepattern)
        {
            ...
            if (extension == "" || extension == ".tif" || extension == ".tiff")
            {
                ...
                for (int i = 0; i < mImageLibrary.Length; i++)
                {
                    string index = string.Format("{0:000}", i);
        ...
        public void CropImagesCenter(int Width, int Height)
        {
         ...
         //   po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => BatchCropImage(x));
        }
        ...
        public void LoadLibrary()
        {
          ...
          //  po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => batchload(x));
        }

        #endregion

        #region BatchSub
        private Image<Gray, float> SubImage;
        private void batchSub(int imagenumber)
        {
            this[imagenumber] = this[imagenumber].Sub(SubImage);
        }
        public void SubLibrary(Image<Gray, float> subImage)
        {
            SubImage = subImage;
           // ParallelOptions po = new ParallelOptions();
           // po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => batchSub(x));
        ...
        #region BatchSub
        private Image<Gray, float> backImage;
        private void batchDivide(int imagenumber)
        {
           this[imagenumber].DivideImage(backImage);
        }
        public void divideLibrary(Image<Gray, float> divImage)
        {
            backImage = divImage;
           // ParallelOptions po = new ParallelOptions();
          //  po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => batchDivide(x));
        ...
        {
            this[imagenumber] = this[imagenumber].Rotate(Degrees, new Gray(0));
        }
        public void RotateLibrary(double degrees)
        {
            Degrees = degrees;
          ...
          //  po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => batchRotate(x));
        ...
        #region BatchDecimate

        private void batchDecimate(int imageNumber)
        {
            mImageLibrary[imageNumber] = mImageLibrary[imageNumber].PyrDown();
        ...
        public void PyrDown()
        {
           ...
           // po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => batchDecimate(x));

        }

        #endregion

        #region BatchMinimize

        private void batchMin(int imageNumber)
        {
            float min = mImageLibrary[imageNumber].Data.MinArray();
            mImageLibrary[imageNumber] = mImageLibrary[imageNumber].Sub(new Gray(min));
        ...
        public void Minimize()
        {
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => batchMin(x));
        ...
        public Image<Gray, float> AverageLibrary()
        {
           ...
           // po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            nProcessors = Program.threadingParallelOptions.MaxDegreeOfParallelism;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => BatchAverageImages(x));
        ...
        public Image<Gray, float> FindBackground()
        {
           ...
           // po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => BatchBackgroundImages(x));
        ...
        public Image<Gray, float> FindBackgroundRegularized()
        {
           ...
           // po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => BatchRegularizedBackgroundImages(x));
        ...
        public Image<Gray, float> FindBackground_Segment()
        {
          ...
          //  po.MaxDegreeOfParallelism = Environment.ProcessorCount - 1;
            ...
            Parallel.For(0, numberOfImages, Program.threadingParallelOptions, x => Batch_BackgroundImages_Value_Segment(x));
